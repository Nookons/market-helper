...
const Footer = () => {
    ...
    return (
        <div className={`grid grid-cols-4 fixed bottom-0 w-full bg-neutral-200 dark:bg-neutral-900 p-4`}>
            <div className={`flex justify-center items-center w-full`}>
                <Link className={`${pathname === "/" && "text-yellow-400"} transition hover:text-yellow-600`}
                      href={`/`}>
